...
const children= true;
  ...
  // console.log("generatecartItemssfrom=== ",generatecartItemssFrom(cartItems,allProducts))
  const fetchCart = async (token) => {
    ...
    try {
      ...
      const data= generateCartItemsFrom(cartData.data,allProducts)
      // console.log(data)
      setCartItems(data)
  ...
  const addToCart = async (
    ...
    try{
      ...
      // console.log(postDataToCart)
 
      const cartTotalItems= generateCartItemsFrom(postDataToCart.data, allProducts)
